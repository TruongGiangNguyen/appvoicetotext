...
public class SearchBox extends RelativeLayout {
	...
	private androidx.fragment.app.Fragment mContainerSupportFragment;
		...
		search.addTextChangedListener(new TextWatcher() {
			...
			public void afterTextChanged(Editable s) {
				if (s.length() > 0) {
					...
					mic.setImageDrawable(getContext().getResources().getDrawable(
							R.drawable.ic_baseline_mic_24_lib));
	 ...
	 * @param context Fragment
	 */
	public void enableVoiceRecognition(androidx.fragment.app.Fragment context) {
